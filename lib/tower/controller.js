...
Tower.Controller = (function(_super) {
  ...
  if (Tower.isClient) {
    Controller.extended = function() {
      var name, object;
      object = {};
      name = this.className();
      object[Tower.Support.String.camelize(name, true)] = Ember.computed(function() {
        return Tower.namespace()[name].create();
      }).cacheable();
      return Tower.namespace().reopen(object);
    };
  }
