...
Tower.Store.MongoDB.Finders = {
  ...
  find: function(conditions, options, callback) {
    ...
    this.through(through, function(error, throughConditions) {
  ...
  findNew: function(conditions, options, callback) {
    var eagerLoad, joins, _ref,
      _this = this;
    conditions = this.serializeQuery(conditions);
    _ref = this.serializeOptions(options), joins = _ref.joins, eagerLoad = _ref.eagerLoad, options = _ref.options;
    this.joins(joins, function(error, joinConditions) {
      return _this.collection().find(conditions, options).toArray(function(error, docs) {
        var doc, model, _i, _j, _len, _len2;
        if (!error) {
          if (!raw) {
  ...
  joins: function(conditions, options, callback) {
    var eagerLoad, raw, through,
      _this = this;
    through = options.through;
