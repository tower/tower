  ...
  __defineProperty(AppGenerator,  "run", function() {
    return this.inside(this.app.name, '.', function() {
      ...
      this.inside("vendor", function() {
        this.inside("javascripts", function() {
          var javascript, twitterBootstrapCommit, _i, _len, _ref, _results;
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            javascript = _ref[_i];
            _results.push(this.get("https://raw.github.com/twitter/bootstrap/" + twitterBootstrapCommit + "/js/" + javascript + ".js", "bootstrap/" + javascript));
          }
          return _results;
        });
