...
Tower.Generator.AppGenerator = (function(_super) {
  ...
  AppGenerator = __extends(AppGenerator, _super);

  __defineProperty(AppGenerator,  "sourceRoot", __dirname);

  __defineProperty(AppGenerator,  "buildApp", function(name) {
    var app;
    if (name == null) {
      name = this.appName;
    }
  ...
  __defineProperty(AppGenerator,  "run", function() {
    var twitterBootstrapCommit;
    ...
    return this.inside(this.app.name, '.', function() {
      ...
      this.inside("vendor", function() {
        this.inside("javascripts", function() {
          ...
          this.get("https://raw.github.com/emberjs/starter-kit/4c946d0ab2d13976bc22ca0c1f5ec8d3fbcd192b/js/libs/ember-0.9.7.1.js", "ember.js");
          ...
          this.get("https://raw.github.com/madrobby/keymaster/c61b3fef9767d4899a1732b089ca70512c9d4261/keymaster.js");
          this.get("https://raw.github.com/mrdoob/stats.js/master/src/Stats.js", "stats.js");
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            javascript = _ref[_i];
            _results.push(this.get("https://raw.github.com/twitter/bootstrap/" + twitterBootstrapCommit + "/js/" + javascript + ".js", "bootstrap/" + javascript + ".js"));
          }
          return _results;
        });
        return this.inside("stylesheets", function() {
          ...
          */
          ...
          _ref = ["accordion", "alerts", "bootstrap", "breadcrumbs", "button-groups", "buttons", "carousel", "close", "code", "component-animations", "dropdowns", "forms", "grid", "hero-unit", "labels-badges", "layouts", "mixins", "modals", "navbar", "navs", "pager", "pagination", "popovers", "progress-bars", "reset", "responsive-1200px-min", "responsive-767px-max", "responsive-768px-979px", "responsive-navbar", "responsive-utilities", "responsive", "scaffolding", "sprites", "tables", "thumbnails", "tooltip", "type", "utilities", "variables", "wells"];
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            stylesheet = _ref[_i];
            _results.push(this.get("https://raw.github.com/twitter/bootstrap/" + twitterBootstrapCommit + "/less/" + stylesheet + ".less", "bootstrap/" + stylesheet + ".less"));
          }
          return _results;
        });
      });
      this.inside("public/images", function() {
        this.get("https://raw.github.com/twitter/bootstrap/" + twitterBootstrapCommit + "/img/glyphicons-halflings.png", "glyphicons-halflings.png");
        return this.get("https://raw.github.com/twitter/bootstrap/" + twitterBootstrapCommit + "/img/glyphicons-halflings-white.png", "glyphicons-halflings-white.png");
      });
