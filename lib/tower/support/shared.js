...
_.extend(Tower, {
  ...
  toMixin: function() {
    return {
      mixin: function() {
        return Tower.mixin.apply(Tower, [this].concat(__slice.call(arguments)));
      },
      extend: function() {
        return Tower.extend.apply(Tower, [this].concat(__slice.call(arguments)));
      },
      include: function() {
  ...
  include: function(self, object) {
    ...
    if (object.hasOwnProperty("ClassMethods")) {
      self.extend(object.ClassMethods);
    }
    if (object.hasOwnProperty("InstanceMethods")) {
      self.include(object.InstanceMethods);
    }
    self.mixin(self.prototype, object);
    if (included) {
