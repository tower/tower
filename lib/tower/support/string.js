...
Tower.Support.String = {
  ...
  constantize: function(string, scope) {
    ...
    return scope[Tower.Support.String.camelize(string)];
  },
  camelize: function(string, firstLetterLower) {
    string = string.replace(Tower.Support.String.camelize_rx, function(str, p1) {
  ...
  underscore: function(string) {
    return string.replace(Tower.Support.String.underscore_rx1, '$1_$2').replace(Tower.Support.String.underscore_rx2, '$1_$2').replace('-', '_').toLowerCase();
  },
  ...
  capitalize: function(string) {
    return string.replace(Tower.Support.String.capitalize_rx, function(m, p1, p2) {
