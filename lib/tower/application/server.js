...
Tower.Application = (function() {
  ...
  Application.prototype.initialize = function() {
    ...
    return this.runCallbacks("initialize", function() {
      var config, configs, path, _i, _j, _len, _len2, _ref, _results;
      requirePaths(File.files("" + Tower.root + "/config/preinitializers"));
      _this.runCallbacks("configure", function() {
        var config, key, path, paths, _i, _j, _len, _len2, _ref;
      ...
      for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
        path = _ref[_j];
        _results.push(requirePaths(File.files("" + Tower.root + "/app/" + path)));
      }
      return _results;
    });
  };
