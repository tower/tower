...
Tower.Application.Assets = {
    ...
    return exec("rm -r public/assets", function() {
      return exec("mkdir public/assets", function() {
        ...
        bundle = function(type, extension, compressor, callback) {
          ...
          return async.forEachSeries(assetBlocks, compile, function(error) {
        ...
        return process.nextTick(function() {
          return async.forEachSeries(bundles, bundleIterator, function(error) {
  ...
  upload: function(block) {
    ...
    return async.forEachSeries(paths, upload, function(error) {
