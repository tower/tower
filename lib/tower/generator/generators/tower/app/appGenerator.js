...
Tower.Generator.AppGenerator = (function(_super) {
  ...
  AppGenerator.prototype.buildProject = function(name) {
    ...
    project.namespace = this.program.namespace;
    return project;
  };

  AppGenerator.prototype.run = function() {
    return this.inside(this.project.name, '.', function() {
      if (!this.program.skipProcfile) this.template("gitignore", ".gitignore");
      this.template("npmignore", ".npmignore");
      if (!this.program.skipProcfile) this.template("slugignore", ".slugignore");
      ...
      this.inside("public", function() {
        ...
        this.template("favicon.png", "favicon.png");
      ...
      this.inside("vendor", function() {
        ...
        return this.inside("stylesheets", function() {
          ...
          this.directory("bootstrap");
          _ref = ["accordion", "alerts", "bootstrap", "breadcrumbs", "button-groups", "buttons", "carousel", "close", "code", "component-animations", "dropdowns", "forms", "grid", "hero-unit", "labels", "layouts", "mixins", "modals", "navbar", "navs", "pager", "pagination", "popovers", "progress-bars", "reset", "responsive", "scaffolding", "sprites", "tables", "thumbnails", "tooltip", "type", "utilities", "variables", "wells"];
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            stylesheet = _ref[_i];
