    ...
    return this.inside(this.project.name, '.', function() {
      ...
      this.inside("lib", function() {
        ...
        return this.inside("stylesheets", function() {
          this.template("code.styl");
          this.template("forms.styl");
          this.template("mixins.styl");
          this.template("reset.styl");
          this.template("tables.styl");
          this.template("typography.styl");
          return this.template("variables.styl");
        });
      });
      this.directory("log");
