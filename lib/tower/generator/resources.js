...
Tower.Generator.Resources = {
  ...
  buildApp: function(name) {
    ...
    return {
      ...
      paramName: Tower.Support.String.parameterize(this.program.namespace),
      paramNamePlural: Tower.Support.String.parameterize(Tower.Support.String.pluralize(this.program.namespace)),
