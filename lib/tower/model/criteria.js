...
Tower.Model.Criteria = (function() {
  ...
  Criteria.prototype.embeds = function() {};

  Criteria.prototype.through = function(scope) {
    return this._through = scope;
  };
  ...
  Criteria.prototype.order = function(attribute, direction) {
    ...
    this._order.push([attribute, direction]);
    return this;
  };
  ...
  Criteria.prototype.merge = function(criteria) {
    ...
    if (attributes._offset != null) this._offset = attributes._offset;
    if (attributes._joins != null) this._joins = attributes._joins;
    if (attributes._through != null) this._through = attributes._through;
    return this;
  };
  ...
  Criteria.prototype.options = function() {
    ...
    if (this._joins != null) options.joins = this._joins;
    if (this._through != null) options.through = this._through;
    return options;
  };
  ...
  Criteria.prototype.attributes = function(to) {
    ...
    if (this._joins != null) to._joins = this._joins;
    if (this._through != null) to._through = this._through;
    return to;
  };
