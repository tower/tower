...
Tower.Model.Relation.HasMany = (function(_super) {
  ...
  HasMany.Scope = (function(_super2) {
    ...
    Scope.prototype.push = function() {
      ...
      return _ref = this._extractArgs(arguments, {
        data: true
      }), criteria = _ref.criteria, data = _ref.data, options = _ref.options, callback = _ref.callback, _ref;
    };

    Scope.prototype.pull = function() {
      var callback, criteria, data, options, _ref;
      return _ref = this._extractArgs(arguments, {
        data: true
      }), criteria = _ref.criteria, data = _ref.data, options = _ref.options, callback = _ref.callback, _ref;
