...
Tower.Model.Scope = (function(_super) {
  ...
  __defineStaticProperty(Scope,  "persistenceMethods", ['insert', 'create', 'update', 'destroy', 'build']);
  ...
  __defineProperty(Scope,  "init", function(cursor) {
