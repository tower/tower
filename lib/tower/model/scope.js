...
Tower.Model.Scope = (function(_super) {
  ...
  Scope.queryMethods = ["where", "order", "sort", "asc", "desc", "gte", "gt", "lte", "lt", "limit", "offset", "select", "joins", "includes", "excludes", "paginate", "page", "within", "allIn", "allOf", "alsoIn", "anyIn", "anyOf", "near", "notIn"];
