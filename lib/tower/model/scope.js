...
Tower.Model.Scope = (function(_super) {
  ...
  Scope.prototype.instantiate = function(value) {
    if (value == null) value = true;
    this.criteria.value.options.instantiate = value;
    return this;
  };
  ...
  Scope.prototype._extractArgsForUpdate = function(args) {
    var callback, criteria, ids, object, scope, updates, _i, _len;
    scope = this.clone();
    criteria = scope.criteria;
  ...
  Scope.prototype._extractArgsForFind = function(args) {
    var callback, criteria, ids, object, scope, _i, _len;
    scope = this.clone();
    criteria = scope.criteria;
    args = _.flatten(_.args(args));
    callback = _.extractBlock(args);
