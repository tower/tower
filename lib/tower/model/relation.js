...
Tower.Model.Relation = (function(_super) {
  ...
  Relation.Criteria = (function(_super1) {
    var Criteria;

    Criteria = __extends(Criteria, _super1);

    __defineProperty(Criteria,  "isConstructable", function() {
    ...
    __defineProperty(Criteria,  "setInverseInstance", function(record) {
      var inverse;
    ...
    __defineProperty(Criteria,  "invertibleFor", function(record) {
      return true;
    });

    __defineProperty(Criteria,  "inverse", function(record) {});

    __defineProperty(Criteria,  "_teardown", function() {
