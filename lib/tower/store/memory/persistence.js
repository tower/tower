...
Tower.Store.Memory.Persistence = {
  ...
  create: function(scope, callback) {
    var criteria, object, result, _i, _len, _ref;
    result = [];
  ...
  update: function(updates, scope, callback) {
    var _this = this;
    return this.find(scope, function(error, records) {
      var record, _i, _len;
  ...
  destroy: function(scope, callback) {
    return this.find(scope, function(error, records) {
      var record, _i, _len;
      if (error) return _.error(error, callback);
      for (_i = 0, _len = records.length; _i < _len; _i++) {
