...
Tower.View.ComponentHelper = {
  formFor: function() {
    var _ref;
    return (_ref = Tower.View.Form).render.apply(_ref, [__cc].concat(__slice.call(arguments)));
  },
  tableFor: function() {
    var _ref;
    return (_ref = Tower.View.Table).render.apply(_ref, [__cc].concat(__slice.call(arguments)));
  },
  widget: function() {},
