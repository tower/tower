  ...
  Compiler = (function() {
    ...
    Compiler.prototype.parse = function(options, callback) {
      ...
      if (!(callback && typeof callback === "function")) {
        Metro.raise("errors.missing_callback", "Asset#parse");
      }
      self = this;
    ...
    Compiler.prototype.parts = function(options, callback) {
      ...
      if (!this.path) {
        Metro.raise("errors.missing_option", "path", "Asset#parse");
      }
      self = this;
      extension = this.extension;
      ...
      if (require_directives) {
        return callback.call(self, self.parse_directives(data, self.path));
      } else {
    ...
    Compiler.prototype.parse_directives = function(string, path) {
