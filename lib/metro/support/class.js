(function() {
  ...
  Class = (function() {
    ...
    Class.include = function(obj) {
      var c, child, clone, cloned, included, key, newproto, oldproto, parent, sn, value, _ref;
      if (!obj) {
      ...
      child = this;
      parent = obj;
      sn = child.__super__ ? child.__super__.constructor.name : "null";
      console.log("" + this.name + ".__super__ (WAS) " + sn + " and WILL BE " + parent.name);
      clone = function(fct) {
        var property;
        clone = function() {
