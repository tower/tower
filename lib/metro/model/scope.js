(function() {
  ...
  */
  ...
  Metro.Model.Scope = (function() {
    ...
    Scope.queryKeywords = ["where", "order", "limit", "offset", "select", "joins", "includes", "excludes", "paginate", "within"];

    function Scope(options) {
      if (options == null) options = {};
      this.sourceClassName = options.sourceClassName;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      Scope.prototype[key] = function() {
        var _ref2;
        (_ref2 = this.criteria)[key].apply(_ref2, arguments);
        return this;
      };
    }
    ...
    Scope.prototype.update = function() {
      ...
      return (_ref2 = this.store()).update.apply(_ref2, __slice.call(ids).concat([this.criteria.query], [this.criteria.options], [callback]));
    };
    ...
    Scope.prototype.destroy = function() {
      var callback, ids, _j, _ref2;
      ids = 2 <= arguments.length ? __slice.call(arguments, 0, _j = arguments.length - 1) : (_j = 0, []), callback = arguments[_j++];
      return (_ref2 = this.store()).destroy.apply(_ref2, __slice.call(ids).concat([this.criteria.query], [this.criteria.options], [callback]));
    };

    Scope.prototype.destroyAll = function(callback) {
      return this.store().destroyAll(this.criteria.query, this.criteria.options, callback);
    };
