(function() {
  ...
  Environment = (function() {
    ...
    Environment.prototype.stylesheet_lookup = function() {
      var directory, extensions, path, paths, _i, _len, _ref, _ref2;
      ...
      return (_ref2 = this._stylesheet_lookup) != null ? _ref2 : this._stylesheet_lookup = new Metro.Support.Lookup({
        root: Metro.root,
        paths: paths,
    ...
    Environment.prototype.javascript_lookup = function() {
      ...
      return (_ref2 = this._javascript_lookup) != null ? _ref2 : this._javascript_lookup = new Metro.Support.Lookup({
        root: Metro.root,
        paths: paths,
        extensions: extensions,
        aliases: {
    ...
    Environment.prototype.paths_for = function(extension) {
      if (extension === ".css") {
        return this.stylesheet_lookup().paths;
      } else if (extension === ".js") {
        return this.javascript_lookup().paths;
      } else {
        return [];
      }
    };
    ...
    Environment.prototype.normalize_extension = function(source, extension) {
      return Metro.Support.Path.basename(source, extension) + extension;
    };
    ...
    Environment.prototype.find = function(source, options) {
      ...
      return new Metro.Assets.Asset(paths[0], options.extension);
    };
