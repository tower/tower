(function() {
  ...
  Processor = (function() {
    ...
    function Processor(compressor, options) {
      if (options == null) {
        options = {};
      }
    ...
    Processor.prototype.render = function(string) {
      return this.process_directives(string);
    };
    Processor.prototype.process_directives = function(string, callback) {
    ...
    Processor.prototype.parse = function(string, path) {
