...
Tower.ViewForm = (function(_super) {
  ...
  function ViewForm(args, options) {
    ...
    if (typeof this.model === "string") {
      klass = (function() {
        try {
          return Tower.constant(Tower.SupportString.camelize(this.model));
        } catch (_error) {}
      }).call(this);
      if (klass) {
  ...
  __defineProperty(ViewForm,  "_extractAttributes", function(options) {
    ...
    attributes.id || (attributes.id = Tower.SupportString.parameterize("" + (this.model.constructor.className()) + "-form"));
