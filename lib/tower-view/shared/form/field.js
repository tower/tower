...
Tower.ViewFormField = (function(_super) {
  ...
  __defineProperty(ViewFormField,  "toId", function(options) {
    ...
    result = typeof this.model === 'object' ? Tower.SupportString.parameterize(this.model.constructor.className()) : this.model;
    if (options.parentIndex) {
      result += "-" + options.parentIndex;
    }
    result += "-" + (Tower.SupportString.parameterize(this.attribute));
  ...
  __defineProperty(ViewFormField,  "toParam", function(options) {
    ...
    result = typeof this.model === 'object' ? Tower.SupportString.camelize(this.model.constructor.className(), true) : this.model;
    if (options.parentIndex) {
      result += "[" + options.parentIndex + "]";
    }
  ...
  function ViewFormField(args, options) {
    ...
    options.as || (options.as = field ? Tower.SupportString.camelize(field.type, true) : "string");
    ...
    classes = [inputType, Tower.SupportString.parameterize(this.attribute), this.inputHTML["class"]];
    if (!(["submit", "fieldset"].indexOf(inputType) > -1)) {
      classes.push(field && field.required ? Tower.View.requiredClass : Tower.View.optionalClass);
      classes.push(field && field.errors ? Tower.View.errorClass : Tower.View.validClass);
      classes.push("input");
