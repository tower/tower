(function() {
  ...
  module.exports = global.Coach = Coach = new (Coach = (function() {
  ...
  Coach.render = function(string, options) {
  ...
  Coach.run = function(argv) {
    return (new Coach.Command.Server(argv)).run();
  };
