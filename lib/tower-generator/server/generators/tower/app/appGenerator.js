var IMAGES, JAVASCRIPTS, STYLESHEETS, SWFS, javascript, stylesheet, twitterBootstrapCommit, _i, _j, _len, _len1, _ref, _ref1,
        ...
        this.inside('public', function() {
          ...
          this.inside('javascripts', function() {
            return this.inside('app', function() {
              return this.inside('templates', function() {
                return this.inside('client', function() {
                  return this.createFile('index.js', '');
                });
              });
            });
          });
