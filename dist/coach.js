(function() {
  var Coach, key, module, specialProperties, _fn, _fn2, _i, _j, _len, _len2, _ref, _ref2;
  ...
  Coach = window.Coach = new (Coach = (function() {
  ...
  window.Coach.logger = this["_console"] ? _console : console;
  ...
  Coach.Class = (function() {

    Class.alias = function(to, from) {
      return Coach.Support.Object.alias(this.prototype, to, from);
    };

    Class.accessor = function(key, callback) {
      Coach.Support.Object.accessor(this.prototype, key, callback);
      return this;
    };

    Class.getter = function(key, callback) {
      Coach.Support.Object.getter(this.prototype, key, callback);
      return this;
    };

    Class.setter = function(key) {
      Coach.Support.Object.setter(this.prototype, key);
      return this;
    };

    Class.classAlias = function(to, from) {
      Coach.Support.Object.alias(this, to, from);
      return this;
    };

    Class.classAccessor = function(key, callback) {
      Coach.Support.Object.accessor(this, key, callback);
      return this;
    };

    Class.classGetter = function(key, callback) {
      Coach.Support.Object.getter(this, key, callback);
      return this;
    };

    Class.classSetter = function(key) {
      Coach.Support.Object.setter(this, key);
      return this;
    };
    ...
    Class.delegate = function(key, options) {
      ...
      Coach.Support.Object.delegate(this.prototype, key, options);
      return this;
    };
    ...
    Class.className = function() {
      return Coach.Support.Object.functionName(this);
    };
  ...
  Coach.Support.I18n = {
    ...
    load: function(pathOrObject, language) {
      ...
      Coach.Support.Object.deepMerge(language, typeof pathOrObject === "string" ? require(pathOrObject) : pathOrObject);
      return this;
    },
    defaultLanguage: "en",
  ...
  Coach.Support.String = {
    camelize_rx: /(?:^|_|\-)(.)/g,
    capitalize_rx: /(^|\s)([a-z])/g,
    underscore_rx1: /([A-Z]+)([A-Z][a-z])/g,
    underscore_rx2: /([a-z\d])([A-Z])/g,
    parameterize: function(string) {
      return Coach.Support.String.underscore(Coach.Support.String.pluralize(string)).replace("_", "-");
    },
  ...
  Coach.Event = (function() {

    __extends(Event, Coach.Class);

    Event["for"] = function(object, key) {
      if (object.isEventEmitter) {
        return object.event(key);
      } else {
        return new Coach.Event(object, key);
      }
    };
  ...
  Coach.Store.Memory.Finders = {
    all: function(query, options, callback) {
      var key, limit, record, records, result, self, sort;
      result = [];
      records = this.records;
      self = this;
      if (Coach.Support.Object.isPresent(query)) {
        sort = options.sort;
        limit = options.limit || Coach.Store.defaultLimit;
        for (key in records) {
          record = records[key];
    ...
    sort: function() {
      var _ref;
      return (_ref = Coach.Support.Array).sortBy.apply(_ref, arguments);
    }
  };
  ...
  Coach.Store.Memory.Serialization = {
    matches: function(record, query) {
      ...
      for (key in query) {
        value = query[key];
        if (!!Coach.Store.reservedOperators[key]) continue;
  ...
  */
  ...
  Coach.Model.Scope = (function() {
    var key, _fn, _i, _len, _ref;

    __extends(Scope, Coach.Class);
    ...
    function Scope(options) {
      ...
      this.criteria = options.criteria || new Coach.Model.Criteria;
    }
    ...
    Scope.prototype.build = function(attributes, callback) {
      return this.store().build(Coach.Support.Object.extend(this.criteria.query, attributes), this.criteria.options, callback);
    };

    Scope.prototype.create = function(attributes, callback) {
      return this.store().create(Coach.Support.Object.extend(this.criteria.query, attributes), this.criteria.options, callback);
    };
  ...
  Coach.Model.Dirty = {
    isDirty: function() {
      return Coach.Support.Object.isPresent(this.changes);
    },
  ...
  Coach.Model.Metadata = {
    ClassMethods: {
      baseClass: function() {
        if (this.__super__ && this.__super__.constructor.baseClass && this.__super__.constructor !== Coach.Model) {
      ...
      stiName: function() {},
      toParam: function() {
        return Coach.Support.String.parameterize(this.className());
      }
    },
    toLabel: function() {
  ...
  Coach.Model.Relation = (function() {

    __extends(Relation, Coach.Class);
    ...
    function Relation(owner, name, options, callback) {
      ...
      this.owner = owner;
      this.name = name;
      this.targetClassName = options.type || options.className || Coach.namespaced(Coach.Support.String.camelize(name));
    ...
    Relation.prototype.scoped = function(record) {
      return new this.constructor.Scope({
        model: Coach.constant(this.targetClassName),
        owner: record,
        relation: this
      });
    };
    ...
    Relation.Scope = (function() {
      ...
      __extends(Scope, Coach.Model.Scope);
  ...
  Coach.Model.Relation.BelongsTo = (function() {

    __extends(BelongsTo, Coach.Model.Relation);
    ...
    function BelongsTo(owner, name, options) {
      ...
      self = this;
      owner.prototype["build" + (Coach.Support.String.camelize(name))] = function(attributes, callback) {
        return this.buildRelation(name, attributes, callback);
      };
      owner.prototype["create" + (Coach.Support.String.camelize(name))] = function(attributes, callback) {
  ...
  Coach.Model.Relation.HasMany = (function() {

    __extends(HasMany, Coach.Model.Relation);
    ...
    function HasMany(owner, name, options) {
      ...
      this.foreignKey = options.foreignKey || Coach.Support.String.camelize("" + owner.name + "Id", true);
      if (this.cache) {
        if (typeof this.cache === "string") {
          this.cache = true;
          this.cacheKey = this.cacheKey;
        } else {
          this.cacheKey = Coach.Support.String.singularize(name) + "Ids";
        }
    ...
    HasMany.Scope = (function() {
      ...
      Scope.prototype.create = function(attributes, callback) {
        ...
        return this.store().create(Coach.Support.Object.extend(this.criteria.query, attributes), this.criteria.options, function(error, record) {
          var updates;
          if (!error) {
  ...
  Coach.Model.Field = (function() {
    ...
    Field.prototype.defaultValue = function(record) {
      ...
      if (Coach.Support.Object.isArray(_default)) {
        ...
        return Coach.Support.Object.extend({}, _default);
  ...
  Coach.Model.Persistence = {
    ClassMethods: {
      load: function(array) {
        ...
        if (!Coach.Support.Object.isArray(array)) array = [array];
        records = this.store().records;
        for (_i = 0, _len = array.length; _i < _len; _i++) {
          item = array[_i];
          record = item instanceof Coach.Model ? item : new this(item);
      ...
      store: function(value) {
        ...
        if (typeof value === "object") {
          this._store || (this._store = new this.defaultStore({
            ...
            className: Coach.namespaced(this.name)
          }));
          Coach.Support.Object.extend(this._store, value);
        } else if (value) {
          this._store = value;
        }
        this._store || (this._store = new this.defaultStore({
      ...
      collectionName: function() {
        return Coach.Support.String.camelize(Coach.Support.String.pluralize(this.name), true);
      },
      resourceName: function() {
        return Coach.Support.String.camelize(this.name, true);
      },
  ...
  Coach.Model.Serialization = {
    ...
    clone: function() {
      return new this.constructor(Coach.Support.Object.clone(this.attributes));
    },
    _serializableHash: function(options) {
      ...
      if (options == null) options = {};
      result = {};
      attributeNames = Coach.Support.Object.keys(this.attributes);
      ...
      if (includes = options.include) {
        ...
        for (_m = 0, _len5 = includes.length; _m < _len5; _m++) {
          include = includes[_m];
          if (!Coach.Support.Object.isHash(include)) {
            tmp = {};
            tmp[include] = {};
            include = tmp;
            tmp = void 0;
  ...
  Coach.Model.Validator = (function() {
    ...
    ClassMethods: {
      validate: function() {
        ...
        if (typeof options !== "object") {
          Coach.raise("missing_options", "" + this.name + ".validates");
        }
        validators = this.validators();
        _results = [];
        for (key in options) {
          value = options[key];
          _results.push(validators.push(Coach.Model.Validator.create(key, value, attributes)));
        }
        return _results;
      },
      validators: function() {
  ...
  Coach.View.Helpers = {
    ...
    javascripts: function(source) {
      ...
      if (Coach.env === "production") {
        ...
        if (Coach.assetHost) path = "" + Coach.assetHost + path;
    ...
    t: function(string) {
      return Coach.translate(string);
    },
    l: function(object) {
      return Coach.localize(string);
    }
  };
  ...
  Coach.View.Rendering = {
    ...
    _renderingContext: function(options) {
      ...
      locals = Coach.Support.Object.extend(locals, options.locals);
  ...
  Coach.Controller.Params = {
    ClassMethods: {
      params: function(options, callback) {
        ...
        if (options) {
          this._paramsOptions = Coach.Support.Object.extend(this._paramsOptions || {}, options);
          callback.call(this);
        }
      ...
      param: function(key, options) {
        ...
        return this._params[key] = Coach.Net.Param.create(key, Coach.Support.Object.extend({}, this._paramsOptions || {}, options));
      }
    },
    criteria: function() {
      var criteria, name, params, parser, parsers;
      if (this._criteria) return this._criteria;
      this._criteria = criteria = new Coach.Model.Criteria;
    ...
    withParams: function(path, newParams) {
      ...
      params = Coach.Support.Object.extend(this.query, newParams);
      if (Coach.Support.Object.blank(params)) return path;
  ...
  Coach.Controller.Processing = {
    call: function(request, response, next) {
      ...
      this.headers = {};
      this.callback = next;
      if (this.format && this.format !== "undefined" && Coach.Support["Path"]) {
        this.contentType = Coach.Support.Path.contentType(this.format);
      } else {
        this.contentType = "text/html";
      }
      return this.process();
  ...
  Coach.Controller.Resources = {
    ClassMethods: {
      ...
      resourceName: function() {
        return this._resourceName || (this._resourceName = Coach.Support.String.camelize(this.resourceType()));
      },
      collectionName: function() {
  ...
  Coach.Net.Param = (function() {
    ...
    Param.create = function(key, options) {
      ...
      return new Coach.Net.Param[options.type](key, options);
    };
    ...
    function Param(key, options) {
      ...
      if (typeof modelName !== "undefined" && modelName !== null) {
        this.namespace = Coach.Support.String.pluralize(this.modelName);
      }
  ...
  Coach.Net.Param.String = (function() {

    __extends(String, Coach.Net.Param);
  ...
  Coach.Net.Route = (function() {

    __extends(Route, Coach.Class);
    ...
    Route.draw = function(callback) {
      return callback.apply(new Coach.Net.Route.DSL(this));
    };
  ...
  Coach.Route = Coach.Net.Route;

  Coach.Net.Route.DSL = (function() {
    ...
    DSL.prototype.match = function() {
      ...
      return Coach.Net.Route.create(new Coach.Net.Route(this._extractOptions.apply(this, arguments)));
    };

    DSL.prototype.get = function() {
      return this.matchMethod("get", Coach.Support.Array.args(arguments));
    };

    DSL.prototype.post = function() {
      return this.matchMethod("post", Coach.Support.Array.args(arguments));
    };

    DSL.prototype.put = function() {
      return this.matchMethod("put", Coach.Support.Array.args(arguments));
    };

    DSL.prototype["delete"] = function() {
      return this.matchMethod("delete", Coach.Support.Array.args(arguments));
    };
    ...
    DSL.prototype.matchMethod = function(method, args) {
      ...
      options.name = name;
      if (this._scope.name) {
        options.name = this._scope.name + Coach.Support.String.camelize(options.name);
      }
      path = "/" + name;
    ...
    DSL.prototype.scope = function(options, block) {
      ...
      this._scope = Coach.Support.Object.extend({}, originalScope, options);
      block.call(this);
    ...
    */
    ...
    DSL.prototype.namespace = function(path, options, block) {
      ...
      options = Coach.Support.Object.extend({
        name: path,
        path: path,
        as: path,
        module: path,
    ...
    DSL.prototype.resource = function(name, options) {
      ...
      this.match("" + name + "/new", Coach.Support.Object.extend({
        action: "new"
      }, options));
      this.match("" + name, Coach.Support.Object.extend({
        action: "create",
        method: "POST"
      }, options));
      this.match("" + name + "/", Coach.Support.Object.extend({
      ...
      this.match("" + name + "/edit", Coach.Support.Object.extend({
        action: "edit"
      }, options));
      this.match("" + name, Coach.Support.Object.extend({
        action: "update",
      ...
      return this.match("" + name, Coach.Support.Object.extend({
        action: "destroy",
        method: "DELETE"
      }, options));
    };
    ...
    DSL.prototype.resources = function(name, options, callback) {
      ...
      if (this._scope.path) path = this._scope.path + path;
      if (this._scope.name) {
        many = this._scope.name + Coach.Support.String.camelize(name);
      } else {
        many = name;
      }
      one = Coach.Support.String.singularize(many);
      this.match("" + path, Coach.Support.Object.extend({
        name: "" + many,
        action: "index"
      }, options));
      this.match("" + path + "/new", Coach.Support.Object.extend({
        name: "new" + (Coach.Support.String.camelize(one)),
        action: "new"
      }, options));
      this.match("" + path, Coach.Support.Object.extend({
        action: "create",
      ...
      this.match("" + path + "/:id", Coach.Support.Object.extend({
        name: "" + one,
        action: "show"
      }, options));
      this.match("" + path + "/:id/edit", Coach.Support.Object.extend({
        name: "edit" + (Coach.Support.String.camelize(one)),
        action: "edit"
      }, options));
      this.match("" + path + "/:id", Coach.Support.Object.extend({
        action: "update",
      ...
      if (callback) {
        this.scope(Coach.Support.Object.extend({
          path: "" + path + "/:" + (Coach.Support.String.singularize(name)) + "Id",
          name: one
        }, options), callback);
      }
      return this;
    ...
    DSL.prototype.root = function(options) {
      return this.match('/', Coach.Support.Object.extend({
        as: "root"
      }, options));
    };
    ...
    DSL.prototype._extractOptions = function() {
      ...
      options = Coach.Support.Object.extend(options, {
        method: method,
    ...
    DSL.prototype._extractConstraints = function(options) {
      return Coach.Support.Object.extend(this._scope.constraints || {}, options.constraints || {});
    };
    ...
    DSL.prototype._extractController = function(options) {
      ...
      return {
        name: controller,
        action: action,
        className: Coach.Support.String.camelize("" + controller)
      };
    };
  ...
  Coach.Net.Route.PolymorphicUrls = {
    ClassMethods: {
      polymorphicUrl: function() {}
    }
  };

  Coach.Net.Route.include(Coach.Net.Route.Urls);

  Coach.Net.Route.include(Coach.Net.Route.PolymorphicUrls);

  Coach.Net.Request = (function() {
  ...
  Coach.Middleware.Router = function(request, response, callback) {
    Coach.Middleware.Router.find(request, response, function(controller) {
      if (controller) {
        ...
        return Coach.Middleware.Router.error(request, response);
      }
    });
    return response;
  };
