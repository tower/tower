class Coach.Net.Param
  ...
  @create: (key, options) ->
    options.type ||= "String"
    new Coach.Net.Param[options.type](key, options)
  ...
  constructor: (key, options = {}) ->
    ...
    @namespace  = Coach.Support.String.pluralize(@modelName) if modelName?
...
class Coach.Net.Param.String extends Coach.Net.Param
  parse: (value) ->
