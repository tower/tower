...
class Coach.Model.Scope extends Coach.Class
  ...
  constructor: (options = {}) ->
    @model    = options.model
    @criteria = options.criteria || new Coach.Model.Criteria
  ...
  build: (attributes, callback) ->
    @store().build Coach.Support.Object.extend(@criteria.query, attributes), @criteria.options, callback
    
  create: (attributes, callback) ->
    @store().create Coach.Support.Object.extend(@criteria.query, attributes), @criteria.options, callback
