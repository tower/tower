...
describe 'Tower.View', ->
  ...
  test 'partial', ->
    Tower.View.cache["test/test-app/app/views/shared/_meta"] = """
      meta charset: "utf-8"
...
"""
  ...
  test "partial with collection", ->
    Tower.View.cache["test/test-app/app/views/posts/_item"] = """
...
"""
  ...
  test "partials within partials with locals", ->
    ...
    Tower.View.cache["test/test-app/app/views/posts/_header"] = """
      header ->
        h1 post.get("title")
    """
